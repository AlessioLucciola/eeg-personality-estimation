...
class EEG_dataloader(DataLoader):
    ...
    def split(self):
        ...
        if self.apply_augmentation:
            train_df = apply_augmentation_to_spectrograms(train_df, time_mask_param=self.augmentation_time_max_param, freq_mask_param=self.augmentation_freq_max_param)
    ...
    def loocv(self):
        ...
        for i, subject_id in enumerate(self.dataset.subject_ids):
            ...
            if self.apply_augmentation:
                train_dataset = apply_augmentation_to_spectrograms(train_dataset, time_mask_param=self.augmentation_time_max_param, freq_mask_param=self.augmentation_freq_max_param)
